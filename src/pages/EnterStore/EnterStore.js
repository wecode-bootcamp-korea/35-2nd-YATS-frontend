...
const EnterStore = () => {
  ...
  const handleCheckbox = e => {
    ...
    const isInfoOfStay = Object.keys(stayInfo).includes(name);
    isInfoOfStay ? stayInfo[name].push(value) : roomInfo[name].push(value);
  };
      ...
      <Container>
        ...
        <Form onSubmit={addStayinList}>
          ...
          <RoomsInfo
            ...
            stayInfo={stayInfo}
          />
          <RoomInfoEnterButton type="submit">소개하기</RoomInfoEnterButton>
        </Form>
      </Container>
    </div>
  );
...
const STAY_DATA = [
  ...
  },
  {
    ...
    option: [
      { type: '오션뷰', id: 70 },
      { type: '루프탑', id: 71 },
      { type: '바다와 가까운 곳', id: 72 },
      { type: 'GARDEN', id: 73 },
      { type: 'ARCHITECTURE', id: 74 },
      { type: 'AIRTUBE', id: 75 },
      { type: 'ENJOYMENT', id: 76 },
      { type: 'EAT', id: 77 },
      { type: 'RELAX', id: 78 },
      { type: 'BBQ', id: 79 },
      { type: 'WELCOME TEA & AMENITY', id: 80 },
    ],
  },
  {
    id: 10,
